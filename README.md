...
| 12        | [Searching Algorithms](/SearchingAlgorithms.md)                                        | Linear search, binary search, and advanced variants (e.g., binary on answer). |
| 13         | [Sorting Algorithms](/sort.md)                                                        | Bubble, selection, merge, quick, and inbuilt sort.                            |
