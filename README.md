...
| 9          | [Queues](/Queue.md)                                                                   | Circular Queue Implementation, Deque Operations, BFS (Breadth-First Search), Sliding Window Maximum, LRU Cache Design, Rotten Oranges (Matrix BFS)                  |
